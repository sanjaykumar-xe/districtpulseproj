    ...
    return (
      <div
        ...
        className={cn(
            ...
            "fixed inset-y-0 z-30 h-svh transition-all duration-300 ease-in-out",
            "bg-sidebar",
  ...
  return (
    <main
      ...
      className={cn(
        ...
        isMobile ? 'ml-0' : (state === "expanded" ? "ml-[var(--sidebar-width)]" : "ml-[var(--sidebar-width-icon)]"),
        className
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button relative flex w-full items-center justify-start rounded-md p-2 text-left text-sm font-medium outline-none ring-sidebar-ring transition-all hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[state=collapsed]:justify-center group-data-[state=collapsed]:p-2 group-data-[state=collapsed]:data-[size=default]:size-10 group-data-[state=collapsed]:data-[size=sm]:size-9 group-data-[state=collapsed]:data-[size=lg]:size-11 group-data-[state=collapsed]:[&>svg]:size-5 [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
  ...
  (
    ...
    const buttonContent = (
      <div className="relative flex items-center w-full">
        {isActive && (
          <div className="absolute left-0 top-1/2 -translate-y-1/2 h-6 w-1 rounded-full bg-primary" />
        )}
        {children}
      </div>
    );
